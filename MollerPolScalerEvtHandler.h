...
class ScalerLoc { // Utility class used by MollerPolScalerEvtHandler
 public:
...
class MollerPolScalerEvtHandler : public THaEvtTypeHandler {

public:

  MollerPolScalerEvtHandler(const char* name, const char* description);
  MollerPolScalerEvtHandler(const MollerPolScalerEvtHandler& fh) = delete;
  MollerPolScalerEvtHandler& operator=(const MollerPolScalerEvtHandler& fh) = delete;
  virtual ~MollerPolScalerEvtHandler();
...
protected:
   ...
   ClassDef(MollerPolScalerEvtHandler,0)  // Scaler Event handler
