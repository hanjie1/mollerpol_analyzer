#ifndef Podd_MollerPolHelicityDecoderBoard_h_
#define Podd_MollerPolHelicityDecoderBoard_h_
...
class MollerPolHelicityDecoderBoard : public THaHelicityDet {
  
public:
  MollerPolHelicityDecoderBoard( const char* name, const char* description, 
	       THaApparatus* a = nullptr );
  MollerPolHelicityDecoderBoard();  // For ROOT RTTI
  virtual ~MollerPolHelicityDecoderBoard();
...
protected:
  ...
  ClassDef(MollerPolHelicityDecoderBoard,0)   // Helicity information from the Helicity Decoder module
