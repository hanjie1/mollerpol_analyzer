// A copy of "SBSHelicityDecoderBoard"
//*-- Original Author :   Paul King  13-April-2025
// Modified by Hanjie Liu, Dec. 16 2025
////////////////////////////////////////////////////////////////////////
//
// MollerPolHelicityDecoderBoard
//
////////////////////////////////////////////////////////////////////////
...
const Int_t  MollerPolHelicityDecoderBoard::fNumDecoderWords = 14;  /// The number of data words in the HD bank; there are at least 6 header/trailer words also

//____________________________________________________________________
MollerPolHelicityDecoderBoard::MollerPolHelicityDecoderBoard( const char* name, const char* description,
			  THaApparatus* app ) : 
...
//____________________________________________________________________
MollerPolHelicityDecoderBoard::MollerPolHelicityDecoderBoard()
  : THaHelicityDet(),
    fHelicityDelay(0)
{
...
Int_t MollerPolHelicityDecoderBoard::Begin( THaRunBase* )
{
  return 0;
}

//_____________________________________________________________________________
Int_t MollerPolHelicityDecoderBoard::End( THaRunBase* )
{
   return 0;
}
...
//____________________________________________________________________
Int_t MollerPolHelicityDecoderBoard::DefineVariables( EMode mode )
{
...
//____________________________________________________________________
Int_t MollerPolHelicityDecoderBoard::ReadDatabase( const TDatime& date )
{
  // Read database
...
//____________________________________________________________________
void MollerPolHelicityDecoderBoard::Clear( Option_t* opt ) 
{
...
//____________________________________________________________________
Int_t MollerPolHelicityDecoderBoard::CheckPredictor(UInt_t& testval)
{
  Int_t  retval;
...
//____________________________________________________________________
UInt_t MollerPolHelicityDecoderBoard::GetRandbit30(UInt_t& ranseed)
{
...
//____________________________________________________________________
Int_t MollerPolHelicityDecoderBoard::Decode( const THaEvData& evdata )
{
...
//____________________________________________________________________
const UInt_t* MollerPolHelicityDecoderBoard::GetBankBuffer( const THaEvData& evdata,
      BANKinfo& info )
{
   ...
   if ((rochead&0xff00)!=0x1000){
      std::cerr <<  "MollerPolHelicityDecoderBoard::GetBankBuffer:  ROC "
		<<  std::dec << info.roc
...
//____________________________________________________________________
Bool_t  MollerPolHelicityDecoderBoard::DecodeBank(const UInt_t *lbuff, const BANKinfo& info)
{
  ...
  if (info.length<fNumDecoderWords+6){
...
//____________________________________________________________________
void MollerPolHelicityDecoderBoard::FillHDVariables(uint32_t data,
					      uint32_t index){
...
//____________________________________________________________________
ClassImp(MollerPolHelicityDecoderBoard)
